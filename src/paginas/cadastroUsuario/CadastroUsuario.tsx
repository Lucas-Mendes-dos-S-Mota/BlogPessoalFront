    ...
    async function onSubmit(e: ChangeEvent<HTMLFormElement>) {
        ...
        toast.success('Usuario cadastrado com sucesso', {
          ...
          navigate("/login")
            ...
            toast.error('Dados inconsistentes. Favor verificar as informaçõ', {
                position: "top-right",
                autoClose: 2000,
                hideProgressBar: false,
                closeOnClick: true,
                ...
                <Grid item xs={6}  justifyContent='center'>
                    <Box paddingX={10}>   
                        <form onSubmit={onSubmit}>
                            ...
                            <TextField value={user.senha} onChange={(e: ChangeEvent<HTMLInputElement>) =>updatedModel(e)} id='senha' label='senha' variant='outlined' name='senha' margin='normal' type='passworld' fullWidth />
